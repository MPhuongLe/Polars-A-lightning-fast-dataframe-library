...
## Run the notebook `1brc`
To experiment with Polars with 1BR data, you can simply run all. Polars run time can vary depending on your device.

To experiment with Pandas chunking, uncomment the Pandas section (note that it would take hours for Pandas to run with no sign of completion as far as I try).
